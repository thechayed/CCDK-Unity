...
namespace CCDKGame
{
    public class HUD : PossessableObject
    {
        ...
        public void SetScaleMode(int mode)
        {
            ...
            {
                case 0:
                    data.canvasGameObject.GetComponent<CanvasScaler>().uiScaleMode = UnityEngine.UI.CanvasScaler.ScaleMode.ConstantPixelSize;
                    break;
                case 1:
                    data.canvasGameObject.GetComponent<CanvasScaler>().uiScaleMode = UnityEngine.UI.CanvasScaler.ScaleMode.ConstantPhysicalSize;
                    break;
                case 2:
                    data.canvasGameObject.GetComponent<CanvasScaler>().uiScaleMode = UnityEngine.UI.CanvasScaler.ScaleMode.ScaleWithScreenSize;
                    break;
                default:
                    data.canvasGameObject.GetComponent<CanvasScaler>().uiScaleMode = UnityEngine.UI.CanvasScaler.ScaleMode.ConstantPixelSize;
                    break;
